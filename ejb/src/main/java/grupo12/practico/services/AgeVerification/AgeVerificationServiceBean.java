...
// PDI FUNCTIONALITY COMMENTED OUT - Not working on deployed instance
...
// import java.util.logging.Level; // Not used when PDI is disabled
...
public class AgeVerificationServiceBean implements AgeVerificationServiceLocal {
    ...
    // private static final int EDAD_MINIMA = 18; // Not used when PDI is disabled
    ...
    public boolean verificarMayorDeEdad(String ci) throws AgeVerificationException {
        ...
        logger.warning("PDI age verification disabled - always returning true for CI: " + ci);
        return true;

        /*
         * ORIGINAL PDI IMPLEMENTATION - COMMENTED OUT
         * try {
         ...
         * if (personaInfo == null) {
         * throw new
         * AgeVerificationException("No se pudo obtener información de la persona con CI: "
         * + ci);
         * }
         * 
         ...
         * throw new
         * AgeVerificationException("No se pudo obtener la fecha de nacimiento para CI: "
         * + ci);
         * }
         * 
         * // Calcular edad
         ...
         * 
         * logger.info("CI: " + ci + ", Fecha nacimiento: " + fechaNacimiento +
         * ", Edad: " + edad);
         * 
         ...
         * logger.log(Level.SEVERE, "Error al consultar servicio PDI para CI: " + ci,
         * e);
         * throw new AgeVerificationException("Error al consultar servicio PDI: " +
         * e.getMessage(), e);
         * } catch (Exception e) {
         * logger.log(Level.SEVERE, "Error inesperado al verificar edad para CI: " + ci,
         * e);
         * throw new AgeVerificationException("Error inesperado al verificar edad: " +
         * e.getMessage(), e);
         * }
         */
    }
