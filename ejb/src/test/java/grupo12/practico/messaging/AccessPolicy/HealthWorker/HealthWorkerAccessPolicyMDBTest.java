...
class HealthWorkerAccessPolicyMDBTest {
    ...
    private HealthWorkerAccessPolicyMDB mdb;

    @BeforeEach
    void setUp() throws Exception {
        mdb = new HealthWorkerAccessPolicyMDB();

        // Inject the mocked service using reflection
        Field serviceField = HealthWorkerAccessPolicyMDB.class.getDeclaredField("accessPolicyService");
    ...
    void onMessage_ShouldProcessValidMessage() throws Exception {
        // Given
        String payload = "12345678|87654321|Hospital Central|REQ-001";
        ...
        // Then
        verify(accessPolicyService).createHealthWorkerAccessPolicy(argThat(dto -> {
            return "12345678".equals(dto.getHealthUserCi()) &&
                    "87654321".equals(dto.getHealthWorkerCi()) &&
    ...
    void onMessage_ShouldProcessValidMessageWithNullAccessRequestId() throws Exception {
        // Given
        String payload = "12345678|87654321|Hospital Central|";
        when(textMessage.getText()).thenReturn(payload);
    ...
    void onMessage_ShouldHandleValidationExceptionFromMessageMapper() throws Exception {
        // Given
        String invalidPayload = "12345678|87654321"; // Missing fields
    ...
    void onMessage_ShouldHandleServiceException() throws Exception {
        ...
        String payload = "12345678|87654321|Hospital Central|REQ-001";
        when(textMessage.getText()).thenReturn(payload);
        when(accessPolicyService.createHealthWorkerAccessPolicy(any()))
        ...
        // Then
        verify(accessPolicyService).createHealthWorkerAccessPolicy(any());
    }
    ...
    void onMessage_ShouldHandleInvalidPayloadFormat() throws Exception {
        // Given
        String invalidPayload = "invalid|format|with|extra|fields|here";
        when(textMessage.getText()).thenReturn(invalidPayload);
